...
const Footer = () => {
  ...
  return (
    <footer className="section-padding">
      <div className="container-max glass-surface px-5 py-10 sm:px-8 sm:py-12 lg:px-12 lg:py-14 text-gray-700">
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              />
              <h3 className="text-2xl font-bold text-gray-900">Zyra Innovations</h3>
            </div>
            <p className="text-gray-700/85 mb-6 leading-relaxed">
        ...
        {/* Divider */}
        <div className="border-t border-white/60 my-12" />
        ...
        >
          {/* Copyright */}
          <p className="text-gray-700/85 text-center md:text-left">
          ...
          {/* Additional Links */}
          <div className="flex gap-6">
            <a href="#" className="text-gray-700/85 hover:text-gray-900 transition-colors duration-300">
              Privacy
            </a>
            <a href="#" className="text-gray-700/85 hover:text-gray-900 transition-colors duration-300">
              Terms
